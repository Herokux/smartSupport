...
<body class="nav-md">
    <div class="container body">
        <div class="main_container" ng-app="myApp" ng-controller="writerdatabase">
                ...
                <div class="nav_menu">
                    <nav class="" role="navigation">
                        <div class="nav toggle">
                            <?php echo $this->Html->link($this->Html->image('full_logo_white.png'),array('controller'=>'Writers','action'=>'dashboard'),array('escape' => false,'class'=>'navbar-brand mylogo')); ?>
...
<!--
                        <?php echo $this->Html->link($this->Html->image('_webicon.png'),array('controller'=>'Writers','action'=>'dashboard'),array('escape' => false,'class'=>'navbar-brand mylogo','id'=>'mylogo-sm')); ?>
                        <?php echo $this->Html->link($this->Html->image('full_logo_white.png'),array('controller'=>'Writers','action'=>'dashboard'),array('escape' => false,'class'=>'navbar-brand mylogo','id'=>'mylogo-md')); ?>
-->
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section" id="nav-tabs">
                            <ul class="nav side-menu">
                                <li ><a data-toggle="tab" ng-click='jobsearch()'><i class="fa fa-pencil"></i> Job Search <span class="fa fa-chevron-right"></span></a>

                                </li>
<!--
                                <li><a><i class="fa fa-bell"></i> Notifications <span class="fa fa-chevron-right"></span></a>
                                </li>
-->
                                <li>
                                    <a ng-click="profile()"><i class="fa fa-user"></i> My Profile <span class="fa fa-chevron-right"></span></a>
                                </li>
                                <li><a ng-click="claimedProjects()"><i class="fa fa-sticky-note"></i> Claimed Projects <span class="fa fa-chevron-right"></span></a>
                        
                                </li>
                                <li><a ng-click='payment()'><i class="fa fa-rupee"></i> Payment <span class="fa fa-chevron-right"></span></a>
                                </li>
                            </ul>
                        </div>
...
-->
    ...
    <?php
        ...
        echo $this->Html->script('writer/custom.js');
